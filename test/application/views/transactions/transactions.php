                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="row">
										...
										<div class="col-sm-2 form-group-sm" style="display: none">
                                            <label for="deliveryAmount">Delivery Charge</label>
                                            <input type="text" class="form-control" id="deliveryAmount">
                                            <span class="help-block errMsg" id="deliveryAmountErr"></span>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 form-group-sm">
                                            ...
                                            <div class="cashAndPos hidden">
                                                <label for="posAmount">PAYPAL</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 form-group-sm">
                                            <label for="custEmail">Customer Address</label>
                                            <input type="email" id="custEmail" class="form-control" placeholder="Address">
                                        </div>
                                    </div>
                                </div>
                            </div>

...
<div id="transReceiptToPrint">
    <div class="row">
        <div class="col-xs-12 text-center text-uppercase">
            <!-- <center style='margin-bottom:5px'><img src="<?=base_url()?>public/images/receipt_logo.png" alt="logo" class="img-responsive" width="70px"></center> -->
            <b>Deshani Gift Corner</b>
            <div>+9197809796361</div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12 text-right">
            <b>Sub-Total: &#x20B9; <?=isset($init_total) ? number_format($init_total, 2) : 0?></b>
        </div>
    </div>
    <hr style='margin-top:2px; margin-bottom:0px'>      
    <div class="row">
    ...
    <div class="row">
        <!-- <div class="col-xs-12 text-right">
            <b>Delivery: &#x20B9; <?=isset($ddeliveryAmount) ? number_format($deliveryAmount, 2) : 0?></b>
        </div> -->
    </div>       
    <div class="row">
        <div class="col-xs-12 text-right">
            <?php if($deliveryAmount > 0): ?>
            <b>Delivery: &#x20B9; <?=isset($deliveryAmount) ? number_format($deliveryAmount, 2) : ""?></b>
            <?php else: ?>
            Free Delivery
            <?php endif; ?>
        </div>
    ...
    <div class="row">
        <div class="col-xs-12 text-right">
            <b>TOTAL AMOUNT: &#x20B9; <?=isset($cumAmount) ? number_format($cumAmount, 2) : ""?></b>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12">
            <b>Customer Address: <?=$cust_email?></b>
        </div>
    </div>
    <br>
    <div class="row">

...
<html>
    ...
    <body>
        <p>Hi <?=$this->input->post('title')." ".$this->input->post('firstName')?>,<br>
            Welcome to Baguio Delibeery Service. Find below your registration details and please do not hesitate to inform us if there is any 
            mistake. Thanks.
        </p>
        ...
        <p><small>The Manager, <br>Baguio Delibeery</small></p>
    </body>
</html>

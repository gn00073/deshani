...
class Transactions extends CI_Controller{
    private $total_before_discount = 0, $discount_amount = 0, $vat_amount = 0, $delivery_amount = 0, $eventual_total = 0;
    ...
    */
    ...
    public function index(){
        $transData['items'] = $this->item->getActiveItems('name', 'ASC');
    ...
    */
    ...
    public function nso_(){
        ...
        $allIsWell = $this->validateItemsDet($arrOfItemsDetails, $cumAmount, $_at, $vatPercentage, $discount_percentage, $deliveryAmount);
        ...
        if($allIsWell){//insert each sales order into db, generate receipt and return info to client
            ...
            $returnedData = $this->insertTrToDb($arrOfItemsDetails, $_mop, $_at, $cumAmount, $_cd, $this->vat_amount, $vatPercentage, $this->discount_amount, $discount_percentage,$deliveryAmount, $cust_name, $cust_phone, $cust_email);
    ...
    */
     ...
     * @return boolean
     */
    private function insertTrToDb($arrOfItemsDetails, $_mop, $_at, $cumAmount, $_cd, $vatAmount, $vatPercentage, $discount_amount, $discount_percentage, $deliveryAmount, $cust_name, $cust_phone, $cust_email){
        ...
        foreach($arrOfItemsDetails as $get){
            ...
            $transId = $this->transaction->add($itemName, $itemCode, "", $qtySold, $unitPrice, $totalPrice, $cumAmount, $_at, $_cd, 
                    $_mop, 1, $ref, $vatAmount, $vatPercentage, $discount_amount, $discount_percentage,$deliveryAmount, $cust_name, $cust_phone, 
                    $cust_email);
        ...
        if($this->db->trans_status() === FALSE){
            ...
            $dataToReturn['transReceipt'] = $this->genTransReceipt($allTransInfo, $cumAmount, $_at, $_cd, $ref, $dateInDb, $_mop, $vatAmount, $vatPercentage, $discount_amount, $discount_percentage,$deliveryAmount, $cust_name, $cust_phone, $cust_email);
    ...
    */
    ...
    private function genTransReceipt($allTransInfo, $cumAmount, $_at, $_cd, $ref, $transDate, $_mop, $vatAmount, $vatPercentage, 
        $discount_amount, $discount_percentage,$delivery_amount, $cust_name, $cust_phone, $cust_email){
		...
		$data['deliveryAmount'] = $delivery_amount;
    ...
    */
    ...
    public function vtr_(){
        ...
        if($transInfo){
			...
			$deliveryAmount = $transInfo[0]['delivery_amount'];
            ...
            $json['transReceipt'] = $this->genTransReceipt($transInfo, $cumAmount, $amountTendered, $changeDue, $ref, 
                $transDate, $modeOfPayment, $vatAmount, $vatPercentage, $discountAmount, $discountPercentage, $delivery_amount,$cust_name,
